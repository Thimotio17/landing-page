...
const PETALS = [
  ...
  { left: 20, size: 11, duration: 12, delay: -2, drift: -120, spin: -530, opacity: 0.78, blur: 0.2 },
  ...
  { left: 55, size: 10, duration: 12, delay: -6, drift: -115, spin: -560, opacity: 0.78, blur: 0.2 },
